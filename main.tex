...
\newcommand{\degreeZH}{博}  % 畢業學位，碩 for masters 或 博 for PHD
\newcommand{\degreeEN}{Doctoral Dissertation}  %  Fill in your degree "Master's Thisis" for masters 或 "Doctoral Dissertation" for PHD
\newcommand{\titleZH}{以腦機介面技術降低高齡者跌倒風險} % 此括弧內填入論文中文標題Chinese title here
\newcommand{\titleEN}{Reducing Risk of Fall in Older Adults using BCI Technology} % 此括弧內填入論文英文標題
\newcommand{\instituteZH}{電機工程學系} % 此括弧內填入畢業生所屬學系班
\newcommand{\instituteEN}{Department of Electrical Engineering} % Graduation Dept./Inst. Name
\newcommand{\studentID}{000000000} %填入畢業生的學號 your student ID
\newcommand{\studentZH}{蔡秉真} % 此括弧內填入畢業生的中文名字 Graduate's Chinese Name here
\newcommand{\studentEN}{Ping-Chen Tsai} %此括弧內填入畢業生的英文姓名 Graduate's Eng. Name here
\newcommand{\advisorZH}{教授名} %此括弧內填入指導教授的中文名字，如有兩個，請自行增加
\newcommand{\advisorEN}{English Name} % 此括弧內填入 advisor's English Name
\newcommand{\yearZH}{115} %此括弧內填入畢業年(民國) Year of ROC  ，就是口試日期的那個月
\newcommand{\monthZH}{3} % Graduation (Oral exam) month of ROC 
\newcommand{\yearEN}{2026} % Graduation (oral exam) Year  
\newcommand{\monthEN}{March} % Graduation (oral Exam) month
